...
We probed **11 judges** with 16 adversarial test cases across all 7 strategies:

### Judge Integrity Leaderboard

| Rank | Judge Model | Type | Integrity Score | Correct | FP | FN | Grade |
|---|---|---|---|---|---|---|---|
...
2. **Reasoning models consistently underperform.** Both reasoning models tested — o3-mini (62.5%) and DeepSeek R1 (68.8%) — score WORSE than Gemini 2.0 Flash (75%, a standard model). Chain-of-thought doesn't confer adversarial judgment. The reasoning just rationalizes the wrong answer more confidently. This is a significant finding: test-time compute doesn't buy judge integrity.
...
| **DeepSeek R1** | JPI + multiple | `jpi-001`, `jpi-002`, `rm-002`, `sa-001`, `pc-001` | Second reasoning model, same story — 5 false negatives. 33% on JPI. Reasoning ≠ adversarial robustness |
...
2. **Reasoning models consistently underperform**: Both o3-mini (62.5%) and DeepSeek R1 (68.8%) score worse than standard Gemini 2.0 Flash (75%). Chain-of-thought rationalizes the wrong answer more confidently. Test-time compute doesn't buy adversarial judge integrity.
